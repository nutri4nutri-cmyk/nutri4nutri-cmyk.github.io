...
function buildWorkshopWelcomeEmail(name) {
  ...
  const meetUrl = String(PropertiesService.getScriptProperties().getProperty(WORKSHOP_MEET_PROPERTY) || WORKSHOP_MEET_URL).trim();
